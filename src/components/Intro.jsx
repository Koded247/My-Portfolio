...
import bg from '../assets/portfoto.jpeg';
...
const Intro = () => {
  return (
    <section id='Home' className='w-screen max-w-6xl mx-auto h-screen flex flex-col md:flex-row items-center justify-between p-4 md:p-8'>
      {/* Left Side - Text */}
      <div className='flex flex-col justify-center gap-4 w-full md:w-1/2 text-center md:text-left shadow-2xl p-4'>
      ...
      <div className='w-full md:w-1/2 flex justify-center md:justify-end mt-8 md:mt-0 '>
        <img src={bg} alt="profile" className='h-auto w-2/3 md:w-3/5 object-cover rounded-full ' />
      </div>
    </section>
  );
}
